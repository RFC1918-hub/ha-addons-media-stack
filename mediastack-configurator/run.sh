...
export RADARR_API_KEY=$(jq -r '.radarr_api_key'       "$OPTIONS")
export SONARR_API_KEY=$(jq -r '.sonarr_api_key'       "$OPTIONS")
export PROWLARR_API_KEY=$(jq -r '.prowlarr_api_key'   "$OPTIONS")
